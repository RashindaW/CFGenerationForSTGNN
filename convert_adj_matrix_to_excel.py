"""
Script to convert adjacency matrix from .npy format to Excel table format.
"""
...
adj_mat_path = 'CFGenerationForSGNN/preprocessing/data/METRLA_SUB_30/adj_mat.npy'
...
# Save to CSV
output_csv = 'CFGenerationForSGNN/preprocessing/data/METRLA_SUB_30/adjacency_matrix.csv'
...
summary_csv = 'CFGenerationForSGNN/preprocessing/data/METRLA_SUB_30/adjacency_matrix_summary.csv'
summary_data = {
